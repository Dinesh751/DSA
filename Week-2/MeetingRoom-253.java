...
public class MeetingRoom253 {
    ...
    public int minMeetingRooms(int[][] intervals) {
         ...
         * 2. Consider sorting by start times
         * 3. Use a data structure to track when current meetings end
         * 4. Priority Queue (Min Heap) might be useful
         * 5. Think about the maximum overlap at any point in time
         */
